...
import src.aspire.volume
from src.aspire.nufft import anufft
from src.aspire.numeric import fft, xp
from src.aspire.utils import grid_2d
from src.aspire.utils.matrix import anorm
...
def _im_translate2(im, shifts):
    ...
    TODO: This implementation has been moved here from src.aspire.aspire.abinitio and is faster than _im_translate.
    """
