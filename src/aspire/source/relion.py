...
from src.aspire.operators import CTFFilter, IdentityFilter
...
class RelionSource(ImageSource):
    ...
    def populate_metadata(self, filepath, data_folder=None, max_rows=None):
        ...
        df = StarFile(filepath).get_block_by_index(-1) # GS EDIT
